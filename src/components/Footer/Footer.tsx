      ...
      <div className="container mx-auto px-0 py-12">
        <div className="w-full flex flex-wrap justify-center px-4">
          ...
          <div className="w-full sm:w-6/12 lg:w-4/12 px-6 py-6">
            ...
            <ul>
              <li>
                <Link to="/projects" className="p-2 hover:text-nav-hover">
                  All Projects
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link
                  to="/projects/sorting-algorithm-visualiser"
                  className="p-2 hover:text-nav-hover"
                >
              ...
              <li>
                <Link
                  to="/projects/graph-algorithm-visualiser"
                  className="p-2 hover:text-nav-hover"
                >
            ...
            <ul>
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-1 hover:text-nav-hover"
                >
                  CV
                </a>
              </li>
              <li>
                <Link to="/about" className="p-1 hover:text-nav-hover">
                  About Me
                </Link>
              </li>
              <li>
                <Link to="/projects" className="p-1 hover:text-nav-hover">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="p-1 hover:text-nav-hover">
                  Privacy
                </Link>
              </li>
