...
export default function ImageModal(props: { src: string, caption: string }) {
    ...
    return (
        ...
        <div className='col-span-12 md:col-span-6 lg:col-span-4'>
            <img loading='lazy' onClick={openModal} className='cursor-pointer border-2 border-link hover:border-link-hover' src={props.src} alt={props.caption} />
            ...
            <div onClick={closeModal} className='fixed bg-opacity-75 h-screen w-full left-0 top-0 flex justify-center items-center bg-black'>
                <div className='bg-white rounded shadow-lg'> 
                    <div className='p-1 items-center justify-center text-center'>
                        <img loading='lazy' className='text-center border-2 border-link max-w-full lg:max-w-screen-lg' src={props.src} alt={props.caption} />
                    </div>
