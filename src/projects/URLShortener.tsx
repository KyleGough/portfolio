...
export default function URLShortener() {
    ...
    return (
        ...
        <Section>
            ...
            <p className='mb-4 max-w-reading'>A URL shortening tool creating using Node.js, Express.js for routing GET and POST requests and MongoDB to store URLs. The project is my first using all three of these technologies. Long URLs are stored in the database and the ID is encoded and used as the short URL.</p>
