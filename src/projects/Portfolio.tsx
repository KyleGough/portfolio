...
export default function Portfolio() {
    ...
    return (
        ...
        <Section>
            ...
            <p className='mb-8'>The initial version created in December 2016 and was a simple site created with HTML, Sass and Bootstrap. As additional project pages were added the CSS framework was ported to Materialize. This version was never made public.</p>
