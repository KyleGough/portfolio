...
export default function About() {
    ...
    return (
        <>
        <Section>
            <h1 className='project-title text-center md:text-left'>Privacy Policy</h1>
            <p className='mt-4 text-link-hover text-center md:text-left'>Last Revised: 17th January 2022</p>
        </Section>
