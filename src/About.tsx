...
export default function About() {
  ...
  const skillsProgramming: [string, number, string, string, string, string][] =
    [
      [
        ...
        90,
        'w-[90%]',
        'Logical Sudoku Solver, Machine Learning, Image Analysis',
        'Confident',
        PythonLogo,
      ],
      [
        ...
        80,
        'w-[80%]',
        'Robot Maze Environment, Steganography, Witter',
        'Confident',
        JavaLogo,
      ],
      [
        ...
        75,
        'w-[75%]',
        'Sorting Visualiser, Delivery Route Planner',
        'Confident',
        CSharpLogo,
      ],
      [
        ...
        65,
        'w-[65%]',
        'GLUT Simulation of a Roller Coaster',
        'Comfortable',
        CPlusPlusLogo,
      ],
      [
        ...
        50,
        'w-[50%]',
        'First Programming Language, CLI Sorting Algorithm Visualiser',
        'Comfortable',
        VBLogo,
      ],
      [
        ...
        40,
        'w-[40%]',
        'Mastermind Coursework, Scratch Clone Coursework',
        'Comfortable',
        HaskellLogo,
      ],
  ...
  const skillsWeb: [string, number, string, string, string, string][] = [
    [
      ...
      90,
      'w-[90%]',
      'Portfolio, LucidLab, Graph Algorithm Visualiser, RSCBot',
      'Confident',
      JavaScriptLogo,
    ],
    ...
    [
      ...
      75,
      'w-[75%]',
      'Portfolio, LucidLab, Minesweeper',
      'Comfortable',
      ReactLogo,
    ],
    ...
    [
      ...
      90,
      'w-[90%]',
      'Portfolio, LucidLab, BSplit, Minesweeper',
      'Confident',
      CSSLogo,
    ],
  ...
  const skillsOther: [string, number, string, string, string, string][] = [
    ...
    [
      ...
      75,
      'w-[75%]',
      'Shell Scripting Exercises, Finding security defects in a VM',
      'Comfortable',
      BashLogo,
    ],
    [
      ...
      85,
      'w-[85%]',
      'Personal Shell of Choice, Everyday use with Manjaro i3',
      'Comfortable',
      TerminalLogo,
    ],
    [
    ...
    [
      ...
      50,
      'w-[50%]',
      'Dissertation, Multiple Group Projects ',
      'Comfortable',
      LatexLogo,
    ],
    [
      ...
      <div className="bg-circuits">
        <Section overrideTopPadding={true}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1 justify-center">
            <ScrollButton
              onClick={() => scrollTo(anchorProgramming)}
              value="Programming Languages"
            />
            <ScrollButton
              onClick={() => scrollTo(anchorWeb)}
              value="Web Development"
            />
            <ScrollButton
              onClick={() => scrollTo(anchorOther)}
              value="Other Technologies"
            />
            <ScrollButton
              onClick={() => scrollTo(anchorGoals)}
              value="Goals for 2022"
            />
            <ScrollButton
              onClick={() => scrollTo(anchorUni)}
              value="University Modules"
            />
          </div>
        </Section>
