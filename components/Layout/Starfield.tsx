...
const FAR_STARS = makeStars(13579, 180, 1, 1.65, 0.3, 0.75);
const MID_STARS = makeStars(97531, 150, 1, 2.3, 0.38, 0.86);
const NEAR_STARS = makeStars(24680, 120, 1.2, 3.1, 0.45, 0.95);
